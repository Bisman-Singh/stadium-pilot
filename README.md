...
- An all-free-tier model chain (`gemini-2.5-flash` with a `gemini-3.1-flash-lite` fallback on a separate quota pool), disabled "thinking", per-attempt timeouts, output token caps,
