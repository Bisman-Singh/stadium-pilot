...
const amenities: Amenity[] = [
  ...
  {
    id: "a-food-2",
    name: "Green Field Vegan Kitchen",
    type: "food",
    zoneId: "CS",
    accessible: true,
    tags: ["vegan", "veg"],
  ...
  {
    id: "a-food-4",
    name: "Free-From Bakehouse",
    type: "food",
    zoneId: "CN",
    accessible: true,
    tags: ["gluten-free", "veg"],
  },
  {
    id: "a-food-5",
    name: "Family Snack Stop",
    type: "food",
    zoneId: "CS",
    accessible: true,
    tags: ["kid-friendly", "veg"],
  },
  {
    id: "a-food-6",
    name: "Pitchside Burgers",
    type: "food",
    zoneId: "PL",
    accessible: true,
    tags: [],
  ...
  {
    id: "a-food-11",
    name: "Plaza Gluten-Free Pizza",
    type: "food",
    zoneId: "PL",
    accessible: true,
    tags: ["gluten-free", "veg", "kid-friendly"],
  },
  {
    id: "a-food-12",
    name: "Transit Coffee & Bites",
    type: "food",
    zoneId: "TH",
    accessible: true,
    tags: ["veg"],
  ...
  {
    id: "a-awc-1",
    name: "North Concourse Accessible Restroom",
  ...
  {
    id: "a-awc-2",
    name: "South Concourse Accessible Restroom",
    type: "accessible-restroom",
    zoneId: "CS",
    accessible: true,
    tags: [],
  ...
  {
    id: "a-awc-3",
    name: "Plaza Accessible Restroom",
    type: "accessible-restroom",
    zoneId: "PL",
    accessible: true,
    tags: [],
  ...
  {
    id: "a-awc-4",
    name: "Transit Hub Accessible Restroom",
    type: "accessible-restroom",
    zoneId: "TH",
    accessible: true,
    tags: [],
  ...
  {
    id: "a-water-1",
    name: "North Concourse Water Refill",
    type: "water-refill",
    zoneId: "CN",
    accessible: true,
    tags: [],
  ...
  {
    id: "a-water-2",
    name: "South Concourse Water Refill",
    type: "water-refill",
    zoneId: "CS",
    accessible: true,
    tags: [],
  ...
  {
    id: "a-aid-1",
    name: "North First Aid Point",
    type: "first-aid",
    zoneId: "CN",
    accessible: true,
    tags: [],
    note: "Trained medics on site during the match.",
  },
  {
    id: "a-aid-2",
    name: "South First Aid Point",
    type: "first-aid",
    zoneId: "CS",
    accessible: true,
    tags: [],
  ...
  {
    id: "a-aid-3",
    name: "Plaza Medical Centre",
    type: "first-aid",
    zoneId: "PL",
    accessible: true,
    tags: [],
    note: "Main medical centre with step-free access.",
  },

  // Prayer / multi-faith and sensory
  {
    id: "a-pray-1",
    name: "North Multi-Faith Prayer Room",
    type: "prayer-room",
    zoneId: "CN",
    accessible: true,
    tags: [],
    note: "Wudu facilities available.",
  },
  {
    id: "a-pray-2",
    name: "South Multi-Faith Prayer Room",
    type: "prayer-room",
    zoneId: "CS",
    accessible: true,
    tags: [],
    note: "Quiet space for all faiths.",
  },
  {
    id: "a-sensory-1",
    name: "Sensory Room",
    ...
    accessible: true,
    tags: ["kid-friendly"],
    note: "Low-stimulation space; ear defenders available.",
  },

  // Recycling
  {
    id: "a-rec-1",
    name: "North Concourse Recycling",
    type: "recycling",
    zoneId: "CN",
    accessible: true,
    tags: [],
  ...
  {
    id: "a-rec-2",
    name: "South Concourse Recycling",
    type: "recycling",
    zoneId: "CS",
    accessible: true,
    tags: [],
  ...
  {
    id: "a-rec-3",
    name: "Plaza Recycling & Cup Return",
    type: "recycling",
    zoneId: "PL",
    accessible: true,
    tags: [],
  ...
  {
    id: "a-info-3",
    name: "North Concourse Info Point",
    type: "info",
    zoneId: "CN",
    accessible: true,
    tags: [],
...
export const VENUE: VenueData = {
  ...
  gates: [
    ...
    {
      id: "E",
      name: "Gate E — Northeast (Step-Free)",
      servesZones: ["N1", "E1"],
      throughputPerMin: 480,
    },
    {
      id: "F",
      name: "Gate F — Southwest (Step-Free)",
      servesZones: ["S1", "W1"],
      throughputPerMin: 480,
    },
  ...
  transit: [
    {
      ...
      headwayMin: 4,
      accessible: true,
      note: "Step-free platform at the Transit Hub. Trains every 4 minutes for 90 minutes after full time.",
    },
    {
      id: "t-shuttle-dt",
      mode: "shuttle",
      ...
      headwayMin: 10,
      accessible: true,
      note: "Low-floor accessible buses to the city centre from the Transit Hub.",
    },
    {
      id: "t-shuttle-air",
      mode: "shuttle",
      ...
      headwayMin: 20,
      accessible: true,
      note: "Direct accessible coach to the airport.",
    },
    {
      id: "t-shuttle-pr",
      mode: "shuttle",
      ...
      headwayMin: 8,
      accessible: true,
      note: "To remote parking Lots 2 to 5.",
    },
    {
      id: "t-rideshare",
      mode: "rideshare",
      name: "Rideshare Pickup — East Plaza",
      accessible: true,
      note: "Designated pickup with an accessible waiting area near Gate G.",
    },
    {
      id: "t-parking-acc",
      mode: "parking",
      name: "Accessible Parking — Lot 1",
      accessible: true,
      note: "120 accessible bays with step-free access to Gate E.",
    },
    {
      id: "t-parking-gen",
      mode: "parking",
      name: "General Parking — Lots 2 to 5",
      accessible: false,
      note: "Use the Park & Ride Shuttle to reach the Transit Hub.",
    },
  ],
};
